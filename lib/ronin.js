...
const MARKETPLACES = {
  ...
  //
  // O PROTOCOLO É O RONKESTRATEGY, NÃO A RONIN MARKET. O rótulo aqui era "Ronin
  // Market" até 24/09/2026, e estava errado. Três sinais independentes:
  //   1. a Ronke Score API devolve este endereço como "RonkeStrategy wallet" no
  //      `owner` dos NFTs que ele segura (#4345, medido em 24/09);
  //   2. o evento é `NFTSoldByProtocol` — venda do estoque de um protocolo;
  //   3. a compra do #4345 feita DESTE contrato não aparece no histórico da
  //      Ronin Market, que só registra venda feita nela.
  // O RonkeStrategy compra Ronkeverse no floor (pela Ronin Market) e revende do
  // próprio estoque por aqui — "vendido pelo RonkeStrategy" é informação que a
  // comunidade quer ver, e "Ronin Market" escondia isso.
  '0x16bb753b48fbeac599a1a7a291b3f87aa3dbdf19': 'RonkeStrategy',
}

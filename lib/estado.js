...
/* 600, NAO 300, e o motivo e um numero que ninguem tinha conferido: o teto de
   duracao da funcao na Vercel e 60s OU 300s conforme a configuracao do projeto.
   Com TTL de 300 a trava podia expirar EXATAMENTE debaixo de um ciclo que ainda
   estava postando -- e ai o retry da Alchemy pega a trava livre, le o MESMO
   ponteiro (gravaBloco so roda no fim) e re-posta tudo o que o primeiro ainda
   nao marcou. A dedup nao segura isso: ela conhece o que JA saiu, nao a fila.
   Com 600 o TTL fica maior que os dois regimes possiveis e ninguem precisa ir
   conferir o painel. Custo de errar pro outro lado: processo que morra
   segurando a trava deixa o bot mudo por ate 10 min em vez de 5 -- e a rede do
   Actions, de 15 em 15 minutos, cobre essa janela. */
const TRAVA_S = 600
